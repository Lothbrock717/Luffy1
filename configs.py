...
class Config(object):
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "8685474581:AAEjp0DQd439a8sTLW8SFGUm9Z2td2ih52w")
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "Testaurofilebot")
  DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1003755083850"))
  ...
  BOT_OWNER = int(os.environ.get("BOT_OWNER", "8235920952"))
  BOT_ADMINS = set(int(x) for x in os.environ.get("BOT_ADMINS", "8235920952").split())
  ...
  LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003755083850"))
